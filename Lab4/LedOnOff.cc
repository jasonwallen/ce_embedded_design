...
{ 
	...
	// Allow user to turn on and off certain LED
	int led_index;
	int state;
	std::cout << "Enter the LED you want to change: ";
	std::cin >> led_index;
	std::cout << "Enter the state you want it to be in (0 or 1): ";
	std::cin >> state;
	SetLedState(ptr, led_index, state);
